...
function showResources()
{
	...
	if(e.length > 0)
		ylog("Links", "h3", true);
	insertStyle(".xlog{ background: #000 !important; color: #FFF !important; margin: 0 !important; padding: 5px 10px !important; }.xlog a{text-decoration: none !important; font: 12px verdana !important; text-transform: none !important; color: #ccc !important; }", "style_show_resources");
}
...
function analyze()
{
	if (!get("#analyzer"))
	{
		...
		insertStyle('body.analyzer {padding-bottom: 300px !important; } #analyzer { padding: 5px 10px !important; position:fixed!important; left:0; bottom: 0; width: 50% !important; min-width: 500px !important; height: 300px!important; overflow: hidden !important; background:#000 !important; border: 2px solid #777 !important; color:#aaa !important; text-align:left !important; z-index:100000 !important; font:11px verdana !important; } #analyzer b { color:#09f !important; } #analyzer div { padding:0;} #analyzer em { font-style:normal; color:#F80 !important; } .hovered { background: #000 !important; color: #FFF !important; }', "analyzer-style");
	}
	else
	{
