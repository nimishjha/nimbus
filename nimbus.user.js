...
function toggleVideoFilter()
{
	if(Nimbus.videoFilter.enabled)
		...
		insertStyle(Nimbus.videoFilter.current, "styleVideoFilter", true);
	Nimbus.videoFilter.enabled = !Nimbus.videoFilter.enabled;
}

function previousVideoFilter()
{
	Nimbus.videoFilter.current = getPrevious(Nimbus.videoFilter.current, Nimbus.videoFilter.styles);
	insertStyle(Nimbus.videoFilter.current, "styleVideoFilter", true);
...
{
 	Nimbus.videoFilter.current = getNext(Nimbus.videoFilter.current, Nimbus.videoFilter.styles);
 	insertStyle(Nimbus.videoFilter.current, "styleVideoFilter", true);
 	Nimbus.videoFilter.enabled = true;
}
